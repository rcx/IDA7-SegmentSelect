...
SegSelect::segments* __cdecl SegSelect::select(UINT flags, LPCSTR title, LPCSTR styleSheet, LPCSTR icon)
{  
...
void _cdecl SegSelect::processIdaEvents() { QApplication::processEvents(); }
